...
import FeatureCard from '@/app/components/molecules/footer/FeatureCard';
import ContactInfo from '@/app/components/molecules/footer/ContactInfo';
import CompanyInfo from '@/app/components/molecules/footer/CompanyInfo';
import { featureList } from '@/configs/footer-data';
